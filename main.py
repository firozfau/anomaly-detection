...
class ExpConfig():
    # This class holds the configuration parameters for the experiment
    dataset = "SMAP"
    val = 0.35
    max_train_size = None
    train_start = 0
    max_test_size = None
    test_start = 0
    input_dim = get_data_dim(dataset)  # This method retrieves the data dimension for the given dataset
    batch_size = 120
    out_dim = 5
    window_length = 20
    hidden_size = 100
...
def main():
    ...
    print("Loading data...")
    # This method loads the data for training and testing
    ...
    # Splits the test data into validation and test sets based on the validation ratio
    ...
    # Creates sliding windows for the data
    ...
    # These methods create data loaders for the train, validation, and test datasets
    ...
    if dataSynchronizationStatus:
        ...
        for epoch in range(numberProcess):
            ...
            # This method checks for anomalies in the validation set
            val_score = model.is_anomaly(val_loader, num_val, con_val)
            # This method performs a brute-force search to find the best threshold
    ...
    # This method checks for anomalies in the test set
    ...
    try:
        ...
        # This method performs clustering on the reshaped test data
        ...
        # This method maps cluster labels to group names
